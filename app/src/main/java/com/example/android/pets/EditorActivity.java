...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentPetUri = myIntent.getData();


        int title = myIntent.getIntExtra(getResources().getString(R.string.intent_parameter_title), R.string.editor_activity_title_new_pet);
        setTitle(title);
    ...
    private boolean isValidFields() {
        return ! (mNameEditText.getText().toString().trim().isEmpty()  ||
                mBreedEditText.getText().toString().trim().isEmpty() ||
                mWeightEditText.getText().toString().trim().isEmpty());
